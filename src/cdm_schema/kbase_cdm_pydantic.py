...
linkml_meta = LinkMLMeta(
    {
        ...
        "name": "cdm_schema",
        "prefixes": {
            "kb_cdm": {"prefix_prefix": "kb_cdm", "prefix_reference": "http://kbase.github.io/cdm-schema/linkml/"},
...
class Table(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"abstract": True, "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_base"}
    )
...
class Association(Table):
    ...
    association_id: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Association", "Association_x_SupportingObject"]}},
    )
    subject: str = Field(
        default=...,
        description="""The subject of an association.""",
    ...
    negated: Optional[bool] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Association"], "ifabsent": "false"}},
    )
    evidence_type: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["evidence code"], "domain_of": ["Association"]}},
    )
    primary_knowledge_source: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Association"]}},
    )
    ...
    comments: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Association", "DataSourceNew"]}},
    )
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_components",
            "slot_usage": {
                "cluster_id": {"identifier": True, "name": "cluster_id"},
                "name": {"description": "Name of the cluster, if available.", "name": "name"},
            },
        }
    )
...
""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Cluster", "ClusterMember"]}},
    )
...
""",
    ...
    is_representative: Optional[bool] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ClusterMember"], "ifabsent": "false"}},
    )
    ...
    score: Optional[float] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ClusterMember"]}},
    )
...
class Event(Table):
    ...
    created_at: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Event", "Experiment", "MeasurementSet", "ProtocolExecution"]}
        },
    )
    description: Optional[str] = Field(
        default=None,
...
class GoldEnvironmentalContext(Table):
    ...
    gold_environmental_context_id: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["GoldEnvironmentalContext"]}},
    )
...
class MixsEnvironmentalContext(Table):
    ...
    mixs_environmental_context_id: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["MixsEnvironmentalContext"]}},
    )
...
class Entity(Table):
    ...
    entity_type: EntityType = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Cluster", "Entity"]}},
    )
    ...
    created: str = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"aliases": ["cdm_created", "cdm_entity_created", "entity_created"], "domain_of": ["Entity"]}
        },
    )
    updated: str = Field(
        default=...,
        ...
        json_schema_extra={
            "linkml_meta": {"aliases": ["cdm_updated", "cdm_entity_updated", "entity_updated"], "domain_of": ["Entity"]}
        },
    )
...
class Identifier(Table):
    ...
    source: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Identifier", "Name"]}},
    )
    relationship: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Identifier"]}},
    )
...
class AttributeMixin(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "any_of": [
                {"slot_conditions": {"attribute_cv_id": {"name": "attribute_cv_id", "required": True}}},
                {"slot_conditions": {"attribute_cv_label": {"name": "attribute_cv_label", "required": True}}},
                {"slot_conditions": {"attribute_string": {"name": "attribute_string", "required": True}}},
            ],
    ...
    attribute_cv_id: Optional[str] = Field(
        default=None,
        ...
        json_schema_extra={
            "linkml_meta": {"aliases": ["attribute term ID", "attribute PID"], "domain_of": ["AttributeMixin"]}
        },
    )
    attribute_cv_label: Optional[str] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["attribute term name"], "domain_of": ["AttributeMixin"]}},
    )
    attribute_string: Optional[str] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["attribute", "tag"], "domain_of": ["AttributeMixin"]}},
    )
...
class EntityMixin(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_attr_value", "mixin": True}
    )
...
class UnitMixin(ConfiguredBaseModel):
    ...
    unit_cv_id: Optional[str] = Field(
        default=None,
        description="""The unit of the quantity, expressed as a CURIE from the Unit Ontology.""",
        json_schema_extra={"linkml_meta": {"aliases": ["unit term ID", "unit PID"], "domain_of": ["UnitMixin"]}},
    )
    unit_cv_label: Optional[str] = Field(
        default=None,
        description="""The unit of a quantity, expressed as the term name of a term from the Unit Ontology or UCUM.""",
        json_schema_extra={"linkml_meta": {"aliases": ["unit term name"], "domain_of": ["UnitMixin"]}},
    )
    unit_string: Optional[str] = Field(
        default=None,
...
class AttributeValue(EntityMixin, AttributeMixin):
    ...
    type: Optional[AttributeValueType] = Field(
        default=None,
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["AttributeValue", "EncodedFeature", "Feature", "Sample", "Sequence"]}
        },
    )
    attribute_cv_id: Optional[str] = Field(
        default=None,
...
class EntityAttributeValue(UnitMixin, EntityMixin, AttributeMixin):
    ...
    language: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                ...
                "domain_of": ["EntityAttributeValue", "TextValue", "ResourceDescription", "ResourceTitle", "Statement"],
    ...
    latitude: Optional[float] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["EntityAttributeValue", "Geolocation"]}},
    )
    ...
    minimum_numeric_value: Optional[float] = Field(
        default=None,
    ...
    maximum_numeric_value: Optional[float] = Field(
        default=None,
    ...
    value_cv_id: Optional[str] = Field(
        default=None,
    ...
    value_cv_label: Optional[str] = Field(
        default=None,
        ...
        json_schema_extra={
            "linkml_meta": {
                ...
                "domain_of": ["EntityAttributeValue", "ControlledTermValue", "ControlledVocabularyTermValue"],
            }
        },
    )
    attribute_cv_id: Optional[str] = Field(
...
class QuantityValue(AttributeValue, UnitMixin):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "mixins": ["UnitMixin"],
            "slot_usage": {
                "numeric_value": {"name": "numeric_value", "required": True},
                "raw_value": {
                    "description": "Unnormalized atomic string representation, suggested syntax {number} {unit}",
                    "name": "raw_value",
                },
                "type": {"ifabsent": 'AttributeValueType("QuantityValue")', "name": "type"},
            },
        }
    )
    ...
    type: Optional[AttributeValueType] = Field(
        default=AttributeValueType.QuantityValue,
        description="""The type of value being represented - e.g. QuantityValue, TextValue, DateTimeValue, ControlledVocabularyTermValue, etc.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["AttributeValue", "EncodedFeature", "Feature", "Sample", "Sequence"],
...
class QuantityRangeValue(AttributeValue, UnitMixin):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "mixins": ["UnitMixin"],
            "slot_usage": {
                "maximum_numeric_value": {"name": "maximum_numeric_value", "required": True},
                "minimum_numeric_value": {"name": "minimum_numeric_value", "required": True},
                "raw_value": {
                    "description": "Unnormalized atomic string "
                    "representation, suggested syntax "
                    "{minimum_number}-{maximum_number} "
                    "{unit}",
                    "name": "raw_value",
                },
                "type": {"ifabsent": 'AttributeValueType("QuantityRangeValue")', "name": "type"},
            },
        }
    )

    maximum_numeric_value: float = Field(
        default=...,
        description="""The maximum value part, expressed as number, of the quantity value when the value covers a range.""",
        json_schema_extra={
            "linkml_meta": {
    ...
    minimum_numeric_value: float = Field(
        default=...,
        description="""The minimum value part, expressed as number, of the quantity value when the value covers a range.""",
        json_schema_extra={
            "linkml_meta": {
    ...
    type: Optional[AttributeValueType] = Field(
        default=AttributeValueType.QuantityRangeValue,
        description="""The type of value being represented - e.g. QuantityValue, TextValue, DateTimeValue, ControlledVocabularyTermValue, etc.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["AttributeValue", "EncodedFeature", "Feature", "Sample", "Sequence"],
...
class DateTimeValue(AttributeValue):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_attr_value",
            "slot_usage": {
                "date_time": {"name": "date_time", "required": True},
                "type": {"ifabsent": 'AttributeValueType("DateTimeValue")', "name": "type"},
            },
        }
    )
    ...
    type: Optional[AttributeValueType] = Field(
        default=AttributeValueType.DateTimeValue,
        description="""The type of value being represented - e.g. QuantityValue, TextValue, DateTimeValue, ControlledVocabularyTermValue, etc.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["AttributeValue", "EncodedFeature", "Feature", "Sample", "Sequence"],
...
class ControlledTermValue(AttributeValue):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_attr_value",
            "slot_usage": {
                "type": {"ifabsent": 'AttributeValueType("ControlledTermValue")', "name": "type"},
                "value_cv_label": {"name": "value_cv_label", "required": True},
            },
        }
    )

    value_cv_label: str = Field(
        default=...,
        description="""For values that are in a controlled vocabulary, ontology, or enumeration, this attribute should capture the term from the controlled vocabulary.""",
        json_schema_extra={
            "linkml_meta": {
    ...
    type: Optional[AttributeValueType] = Field(
        default=AttributeValueType.ControlledTermValue,
        description="""The type of value being represented - e.g. QuantityValue, TextValue, DateTimeValue, ControlledVocabularyTermValue, etc.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["AttributeValue", "EncodedFeature", "Feature", "Sample", "Sequence"],
...
class ControlledVocabularyTermValue(AttributeValue):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "any_of": [
                {"slot_conditions": {"value_cv_id": {"name": "value_cv_id", "required": True}}},
                {"slot_conditions": {"value_cv_label": {"name": "value_cv_label", "required": True}}},
            ],
            "class_uri": "nmdc:ControlledIdentifiedTermValue",
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_attr_value",
            "slot_usage": {"type": {"ifabsent": 'AttributeValueType("ControlledVocabularyTermValue")', "name": "type"}},
        }
    )
    ...
    type: Optional[AttributeValueType] = Field(
        default=AttributeValueType.ControlledVocabularyTermValue,
        description="""The type of value being represented - e.g. QuantityValue, TextValue, DateTimeValue, ControlledVocabularyTermValue, etc.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["AttributeValue", "EncodedFeature", "Feature", "Sample", "Sequence"],
...
class TextValue(AttributeValue):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "slot_usage": {
                ...
                "type": {"ifabsent": 'AttributeValueType("TextValue")', "name": "type"},
            },
        }
    )
    ...
    type: Optional[AttributeValueType] = Field(
        default=AttributeValueType.TextValue,
        description="""The type of value being represented - e.g. QuantityValue, TextValue, DateTimeValue, ControlledVocabularyTermValue, etc.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["AttributeValue", "EncodedFeature", "Feature", "Sample", "Sequence"],
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_credit",
            "represents_relationship": True,
            "slot_usage": {"contributor_id": {"multivalued": True, "name": "contributor_id"}},
        }
    )

    contributor_id: list[str] = Field(
        default=...,
        description="""Internal (CDM) unique identifier for a contributor.
From the Entity table: entity_id where entity_type == 'Contributor'.
""",
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "slot_usage": {"contributor_role": {"name": "contributor_role", "required": False}},
        }
    )
...
""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Contributor_x_Role_x_Project", "Project"]}},
    )
    contributor_role: Optional[ContributorRole] = Field(
        default=None,
        description="""Role(s) played by the contributor when working on the experiment. If more than one role was played, additional rows should be added to represent each role.""",
...
class DataSourceNew(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "any_of": [
                {"slot_conditions": {"date_updated": {"name": "date_updated", "required": True}}},
            ...
            "slot_usage": {
                ...
                "name": {
                    ...
                    "examples": [{"value": "UniProt"}, {"value": "NMDC Runtime API"}, {"value": "NCBI RefSeq"}],
                    "name": "name",
                },
            },
        }
...
""",
    ...
    date_accessed: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSourceNew"]}},
    )
    date_published: Optional[str] = Field(
        default=None,
        description="""The date when the data source was originally made public.""",
        json_schema_extra={"linkml_meta": {"aliases": ["date_created"], "domain_of": ["DataSourceNew"]}},
    )
...
""",
    ...
    url: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSourceNew", "License", "Protocol"]}},
    )
    version: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                ...
                "examples": [{"value": "5"}, {"value": "1.2.1"}, {"value": "20220405"}, {"value": "v1.5.3"}],
...
""",
    ...
    resource_description_id: str = Field(
        default=...,
        description="""Unique identifier for a description for a resource.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSource_x_Description", "ResourceDescription"]}},
    )
...
""",
    ...
    funding_reference_id: str = Field(
        default=...,
...
""",
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSource_x_FundingReference", "FundingReference"]}},
    )
...
""",
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSource_x_License", "License"]}},
    )
...
""",
    ...
    resource_title_id: str = Field(
        default=...,
        description="""Unique identifier for a title for a resource.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSource_x_Title", "ResourceTitle"]}},
    )
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_credit",
            "slot_usage": {"funding_reference_id": {"identifier": True, "name": "funding_reference_id"}},
        }
    )
...
""",
    ...
    funder: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["FundingReference"], "slot_uri": "schema:funder"}},
    )
...
""",
    ...
    id: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["License"]}},
    )
    name: Optional[str] = Field(
        default=None,
...
class Publication(Table):
    ...
    publication_id: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Publication"]}},
    )
...
class Prefix(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "sh:PrefixDeclaration", "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_ontology"}
    )

    prefix: Optional[str] = Field(
        default=None,
        description="""A standardized prefix such as 'GO' or 'rdf' or 'FlyBase'.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Prefix"], "slot_uri": "sh:prefix"}},
    )
    base: Optional[str] = Field(
        default=None,
        description="""The base URI a prefix will expand to.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Prefix"], "slot_uri": "sh:namespace"}},
    )
...
class Statement(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "slot_usage": {
                "object": {"name": "object", "range": "local_curie"},
    ...
    value: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                ...
                "domain_of": ["Statement", "ExperimentCondition", "Measurement", "ProtocolInput", "ProtocolOutput"],
                "slot_uri": "rdf:object",
            }
        },
    )
    datatype: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"comments": ["only used when value is populated"], "domain_of": ["Statement"]}
        },
    )
    language: Optional[str] = Field(
        default=None,
...
class Experiment(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "slot_usage": {
                "description": {"description": "Brief explanation of what was done.", "name": "description"},
                "experiment_id": {"identifier": True, "name": "experiment_id"},
                "name": {"description": "Name or title of the experiment.", "name": "name"},
            },
        }
    )
    ...
    experiment_id: str = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Experiment", "ExperimentCondition"], "slot_uri": "CDM:experiment_id"}
        },
    )
...
class ExperimentCondition(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"experiment_condition_id": {"identifier": True, "name": "experiment_condition_id"}},
        }
    )

    experiment_condition_id: str = Field(
        default=...,
    ...
    variable_id: str = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["ExperimentCondition", "MeasurementSet", "ProtocolVariable", "Variable", "VariableValue"],
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "comments": ["Grouping table to collate unique sets of `experiment_condition_id`s."],
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
        }
    )

    experiment_condition_set_id: str = Field(
        default=...,
...
class Measurement(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "aliases": ["computed measurement", "matrix entry", "observation", "result", "results"],
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"measurement_id": {"identifier": True, "name": "measurement_id"}},
        }
    )
    ...
    measurement_id: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Measurement"], "slot_uri": "CDM:measurement_id"}},
    )
    measurement_set_id: str = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Measurement", "MeasurementSet"], "slot_uri": "CDM:measurement_set_id"}
        },
    )
    experiment_condition_set_id: str = Field(
        default=...,
...
class MeasurementSet(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "aliases": ["experiment variable measurement set"],
            "comments": ["Grouping table to collate a set of protocol outputs by variable, quality, and timestamp."],
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"measurement_set_id": {"identifier": True, "name": "measurement_set_id"}},
        }
    )
    ...
    quality: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["MeasurementSet"]}},
    )
    created_at: Optional[str] = Field(
        default=None,
...
""",
    ...
    protocol_step_id: str = Field(
        default=...,
        description="""Internal CDM unique identifier for a step in a protocol.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["OrderedProtocolStep", "ProtocolStep"], "slot_uri": "CDM:protocol_step_id"}
        },
    )
    step_index: int = Field(
        default=...,
        description="""The number of the step in an ordered progression.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["OrderedProtocolStep"]}},
    )
...
class Parameter(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {
                "parameter_id": {"aliases": ["protocol_parameter_id"], "identifier": True, "name": "parameter_id"}
            },
        }
    )
    ...
    value_type: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                ...
                "examples": [{"value": "boolean"}, {"value": "SomeSpecifiedEnum"}, {"value": "integer"}],
            }
        },
    )
    ...
    default: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Parameter"], "examples": [{"value": "false"}, {"value": "42"}]}
        },
    )
    parameter_type: Optional[ProtocolParameterType] = Field(
        default=None,
        description="""Whether the parameter applies to the protocol input or output.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Parameter"], "examples": [{"value": "input"}, {"value": "output"}]}
        },
    )
...
""",
    ...
    version: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSourceNew", "Protocol"]}},
    )
...
class ProtocolExecution(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"protocol_execution_id": {"identifier": True, "name": "protocol_execution_id"}},
        }
    )

    protocol_execution_id: str = Field(
        default=...,
...
class ProtocolInput(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"protocol_input_id": {"identifier": True, "name": "protocol_input_id"}},
        }
    )
    ...
    parameter_id: str = Field(
        ...
        description="""Internal (CDM) unique identifier for a parameter of a protocol.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Parameter", "ProtocolInput"], "slot_uri": "CDM:parameter_id"}
        },
    )
    protocol_input_id: str = Field(
        default=...,
        description="""Internal CDM unique identifier for the value of an input parameter for a protocol.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["ProtocolInput", "ProtocolInputSet"], "slot_uri": "CDM:protocol_input_id"}
        },
    )
    protocol_execution_id: str = Field(
        default=...,
...
class ProtocolInputSet(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"protocol_input_set_id": {"identifier": True, "name": "protocol_input_set_id"}},
        }
    )
    ...
    protocol_input_set_id: str = Field(
        default=...,
...
class ProtocolOutput(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"protocol_output_id": {"identifier": True, "name": "protocol_output_id"}},
        }
    )

    protocol_output_id: str = Field(
        default=...,
        description="""Internal CDM unique identifier for the value of an output of a protocol.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ProtocolOutput"], "slot_uri": "CDM:protocol_output_id"}},
    )
    protocol_input_set_id: str = Field(
        default=...,
        description="""Internal CDM unique identifier for a set of input parameter values for a protocol.""",
...
class ProtocolStep(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"protocol_step_id": {"identifier": True, "name": "protocol_step_id"}},
        }
    )
...
class VariableValue(Table):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_protocol",
            "slot_usage": {"variable_value_id": {"identifier": True, "name": "variable_value_id"}},
        }
    )

    variable_value_id: str = Field(
        default=...,
        description="""Internal CDM unique identifier for a variable value.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["VariableValue"], "slot_uri": "CDM:variable_value_id"}},
    )
    variable_id: str = Field(
        default=...,
        description="""Internal CDM unique identifier for a variable.""",
    ...
    value_type: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Parameter", "Variable", "VariableValue"]}}
    )
...
""",
    ...
    hash: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Contig", "ContigCollection", "EncodedFeature", "Feature", "Protein"]}
        },
    )
    gc_content: Optional[float] = Field(
        default=None,
        description="""GC content of the contig, expressed as a percentage.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Contig"]}},
    )
    length: Optional[int] = Field(
        default=None,
        description="""Length of the contig in bp.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Contig", "Protein", "Sequence"]}},
    )
...
""",
    ...
    asm_score: Optional[float] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ContigCollection"]}},
    )
    checkm_completeness: Optional[float] = Field(
        default=None,
    ...
    checkm_contamination: Optional[float] = Field(
        default=None,
    ...
    checkm_version: Optional[str] = Field(
        default=None,
    ...
    contig_bp: Optional[int] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"aliases": ["sequence length", "total sequence length"], "domain_of": ["ContigCollection"]}
        },
    )
    ...
    contig_l50: Optional[int] = Field(
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["ctg_L50", "contig_L50"], "domain_of": ["ContigCollection"]}},
    )
    contig_l90: Optional[int] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["ctg_L90", "contig_L90"], "domain_of": ["ContigCollection"]}},
    )
    contig_n50: Optional[int] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["ctg_N50", "contig_N50"], "domain_of": ["ContigCollection"]}},
    )
    contig_n90: Optional[int] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["ctg_N90", "contig_N90"], "domain_of": ["ContigCollection"]}},
    )
    contig_logsum: Optional[float] = Field(
        default=None,
        description="""The sum of the (length*log(length)) of all contigs, times some constant.""",
        json_schema_extra={"linkml_meta": {"aliases": ["ctg_logsum"], "domain_of": ["ContigCollection"]}},
    )
    contig_max: Optional[int] = Field(
        default=None,
        description="""Maximum contig length""",
        json_schema_extra={"linkml_meta": {"aliases": ["ctg_max"], "domain_of": ["ContigCollection"]}},
    )
    contig_powersum: Optional[float] = Field(
        default=None,
    ...
    gap_percent: Optional[float] = Field(
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["gap_pct"], "domain_of": ["ContigCollection"]}},
    )
    gc_average: Optional[float] = Field(
        default=None,
        description="""The average GC content of the contig collection, expressed as a percentage""",
        json_schema_extra={"linkml_meta": {"aliases": ["gc_avg"], "domain_of": ["ContigCollection"]}},
    )
    gc_std: Optional[float] = Field(
        default=None,
        description="""The standard deviation of GC content across the contig collection""",
        json_schema_extra={"linkml_meta": {"aliases": ["gc_stdev"], "domain_of": ["ContigCollection"]}},
    )
    gtdb_taxon_id: Optional[str] = Field(
        default=None,
        description="""The GTDB taxon ID for this contig collection.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ContigCollection"]}},
    )
    n_chromosomes: Optional[int] = Field(
        default=None,
    ...
    ncbi_taxon_id: Optional[str] = Field(
        default=None,
        description="""The NCBI taxon ID for this contig collection.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ContigCollection"]}},
    )
    scaffold_l50: Optional[int] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["scaf_L50", "scaffold_L50"], "domain_of": ["ContigCollection"]}},
    )
    scaffold_l90: Optional[int] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["scaf_L90", "scaffold_L90"], "domain_of": ["ContigCollection"]}},
    )
    scaffold_n50: Optional[int] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["scaf_N50", "scaffold_N50"], "domain_of": ["ContigCollection"]}},
    )
    scaffold_n90: Optional[int] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["scaf_N90", "scaffold_N90"], "domain_of": ["ContigCollection"]}},
    )
    scaffold_bp: Optional[int] = Field(
        default=None,
        description="""Total size in bp of all scaffolds""",
        json_schema_extra={"linkml_meta": {"aliases": ["scaf_bp"], "domain_of": ["ContigCollection"]}},
    )
    scaffold_logsum: Optional[float] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"aliases": ["scaf_logsum"], "domain_of": ["ContigCollection"]}},
    )
    scaffold_maximum_length: Optional[int] = Field(
        default=None,
        description="""Maximum scaffold length""",
        json_schema_extra={"linkml_meta": {"aliases": ["scaf_max", "scaffold_max"], "domain_of": ["ContigCollection"]}},
    )
    scaffold_powersum: Optional[float] = Field(
        default=None,
        ...
        json_schema_extra={
            "linkml_meta": {"aliases": ["scaf_powsum", "scaffold_powsum"], "domain_of": ["ContigCollection"]}
        },
    )
    scaffolds_n_over_50K: Optional[int] = Field(
        default=None,
        description="""The number of scaffolds longer than 50,000 base pairs.""",
        json_schema_extra={
            "linkml_meta": {"aliases": ["scaf_n_gt50K", "scaffold_n_gt50K"], "domain_of": ["ContigCollection"]}
        },
    )
    scaffolds_percent_over_50K: Optional[float] = Field(
        default=None,
        description="""The percentage of the total assembly length represented by scaffolds longer than 50,000 base pairs""",
        json_schema_extra={
            "linkml_meta": {"aliases": ["scaf_pct_gt50K", "scaffold_pct_gt50K"], "domain_of": ["ContigCollection"]}
        },
    )
    scaffolds_total_length_over_50k: Optional[int] = Field(
        default=None,
        description="""The total length of scaffolds longer than 50,000 base pairs""",
        json_schema_extra={
            "linkml_meta": {"aliases": ["scaf_l_gt50k", "scaffold_l_gt50k"], "domain_of": ["ContigCollection"]}
        },
    )
...
""",
    ...
    has_stop_codon: Optional[bool] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["EncodedFeature"]}},
    )
...
""",
    ...
    cds_phase: Optional[CdsPhaseType] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Feature"]}},
    )
...
""",
    ...
    evidence_for_existence: Optional[ProteinEvidenceForExistence] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Protein"]}},
    )
    length: Optional[int] = Field(
        default=None,
...
""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Sample"]}},
    )
    description: Optional[str] = Field(
        default=None,
...
""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Sequence"]}},
    )
    entity_id: str = Field(
        default=...,
...
class EncodedFeatureXFeature(LinkerTable):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_schema", "represents_relationship": True}
    )
...
class Schema(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"abstract": True, "from_schema": "http://kbase.github.io/cdm-schema/linkml/cdm_schema", "tree_root": True}
    )
