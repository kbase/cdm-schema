...
- [Contributing to cdm-schema](#contributing-to-cdm-schema)
...
The KBase CDM schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the cdm-schema technical leads
